...
fprintf('\n(1) Height +5m\n');
fprintf('Old LOS: %.1f km\n', 3.57*(sqrt(htx)+sqrt(hrx)));
fprintf('New LOS: %.1f km\n', maxLOS_1);

% NOTE:
% Path loss model does not depend on height,
% so received power curve does NOT change.
legend('Baseline','Sensitivity','Location','best');
%% ===============================
...
fprintf('\n(2) Gains set to 5 dBi\n');

legend('Baseline','Sensitivity','Gain = 5 dBi','Location','best');
%% ===============================
% (3) Environment exponent n = 2.0
%% ===============================
n_3 = 4.0;
...
fprintf('\n(3) Environment exponent n = %.1f\n', n_3);

legend('Baseline','Sensitivity','n = 2.0','Location','best');
%% ===============================
% (4) Fresnel study
%% ===============================
xObs_4 = 0.1*D;
...
fprintf('\n(4) Obstacle at 10%% of link\n');
fprintf('Fresnel radius = %.2f m\n', rF_4);
fprintf('Required 60%% = %.2f m\n', requiredClear_4);
fprintf('Clearance OK = %s\n', string(fresnelOK_4));